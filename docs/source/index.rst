...
Welcome to genotype data analysis UMCG-GRIAC documentation!
==============================================================
**Genotype data analysis UMCG-GRIAC** workflow to cover processing *genotype data* from intensities to imputation and *GWAS analysis*. 
